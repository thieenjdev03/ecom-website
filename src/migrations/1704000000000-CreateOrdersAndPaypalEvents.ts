...
export class CreateOrdersAndPaypalEvents1704000000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      CREATE INDEX idx_orders_paypalOrderId ON orders("paypalOrderId");
    ...
    await queryRunner.query(`
      CREATE UNIQUE INDEX idx_paypal_events_eventId ON paypal_events("eventId");
      CREATE INDEX idx_paypal_events_orderId ON paypal_events("orderId");
      CREATE INDEX idx_paypal_events_type ON paypal_events(type);
      CREATE INDEX idx_paypal_events_createdAt ON paypal_events("createdAt");
    `);
  }
