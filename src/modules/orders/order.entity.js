...
var Order = function () {
    ...
    var _paymentInfo_decorators;
    var _paymentInfo_initializers = [];
    var _paymentInfo_extraInitializers = [];
    ...
    var Order = _classThis = /** @class */ (function () {
        function Order_1() {
            ...
            this.total = (__runInitializers(this, _userId_extraInitializers), __runInitializers(this, _total_initializers, void 0));
            ...
            this.paymentInfo = (__runInitializers(this, _shippingAddress_extraInitializers), __runInitializers(this, _paymentInfo_initializers, void 0));
            this.createdAt = (__runInitializers(this, _paymentInfo_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _total_decorators = [(0, typeorm_1.Column)({ type: 'numeric', precision: 12, scale: 2 })];
        _status_decorators = [(0, typeorm_1.Column)({ default: 'PENDING' })];
        _items_decorators = [(0, typeorm_1.Column)({ type: 'json' })];
        _shippingAddress_decorators = [(0, typeorm_1.Column)({ type: 'json', nullable: true })];
        ...
        __esDecorate(null, null, _paymentInfo_decorators, { kind: "field", name: "paymentInfo", static: false, private: false, access: { has: function (obj) { return "paymentInfo" in obj; }, get: function (obj) { return obj.paymentInfo; }, set: function (obj, value) { obj.paymentInfo = value; } }, metadata: _metadata }, _paymentInfo_initializers, _paymentInfo_extraInitializers);
