...
var OrdersService = function () {
    ...
    var OrdersService = _classThis = /** @class */ (function () {
        function OrdersService_1(orderRepository) {
            this.orderRepository = orderRepository;
        }
        OrdersService_1.prototype.create = function (createOrderDto) {
            return __awaiter(this, void 0, void 0, function () {
                var order;
                return __generator(this, function (_a) {
                    order = this.orderRepository.create(__assign(__assign({}, createOrderDto), { total: this.calculateTotal(createOrderDto.items) }));
        ...
        OrdersService_1.prototype.calculateTotal = function (items) {
