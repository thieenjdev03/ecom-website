...
var Product = function () {
    ...
    var Product = _classThis = /** @class */ (function () {
        function Product_1() {
            ...
            this.stock = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _stock_initializers, void 0));
    ...
    (function () {
        ...
        _currency_decorators = [(0, typeorm_1.Column)({ default: 'VND' })];
        _status_decorators = [(0, typeorm_1.Column)({ default: 'ACTIVE' })];
        _stock_decorators = [(0, typeorm_1.Column)({ default: 0 })];
        _images_decorators = [(0, typeorm_1.Column)({ type: 'json', nullable: true })];
