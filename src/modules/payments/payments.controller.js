...
var PaymentsController = function () {
    ...
    var PaymentsController = _classThis = /** @class */ (function () {
        ...
        PaymentsController_1.prototype.createPayPalOrder = function (orderData) {
            return this.paymentsService.createPayPalOrder(orderData);
        };
        PaymentsController_1.prototype.capturePayPalOrder = function (orderId) {
            return this.paymentsService.capturePayPalOrder(orderId);
        };
        PaymentsController_1.prototype.handleWebhook = function (webhookData) {
    ...
    (function () {
        ...
        _createPayPalOrder_decorators = [(0, common_1.Post)('paypal/create')];
        _capturePayPalOrder_decorators = [(0, common_1.Post)('paypal/capture/:orderId')];
        _handleWebhook_decorators = [(0, common_1.Post)('paypal/webhook')];
