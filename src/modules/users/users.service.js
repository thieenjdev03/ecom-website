    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.create = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, role, hashedPassword, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            user = this.usersRepository.create({ email: email, password: hashedPassword, role: role });
        ...
        UsersService_1.prototype.update = function (id, updateUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var password, profile, hashedPassword, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            password = updateUserDto.password, profile = updateUserDto.profile;
                        ...
                        case 3:
                            hashedPassword = _a;
                            return [4 /*yield*/, this.usersRepository.update(id, __assign(__assign({}, (password && { password: hashedPassword })), (profile && { profile: profile })))];
                        case 4:
                            _b.sent();
                            return [2 /*return*/];
                    }
