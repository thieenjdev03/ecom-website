...
var UsersController = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            user = req.user;
                            return [4 /*yield*/, this.usersService.update(user.id, updateUserDto)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.usersService.findOneByEmail(user.email)];
                    }
                });
            });
        };
        UsersController_1.prototype.deleteProfile = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            user = req.user;
                            return [4 /*yield*/, this.usersService.remove(user.id)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    (function () {
        ...
        _deleteProfile_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Delete)('profile')];
        ...
        __esDecorate(_classThis, null, _deleteProfile_decorators, { kind: "method", name: "deleteProfile", static: false, private: false, access: { has: function (obj) { return "deleteProfile" in obj; }, get: function (obj) { return obj.deleteProfile; } }, metadata: _metadata }, null, _instanceExtraInitializers);
